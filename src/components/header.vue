...
export default defineComponent({
	...
	setup(props, { emit }) {
		...
		const sortSync = useSync(
			props,
			"sort",
			emit
		);
		const selectionSync = useSync(
			props,
			"selection",
			emit
		);
